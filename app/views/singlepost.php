              ...
              <article class="post-item">
                <div class="post-content">
                  ...
                  <div class="hero-image col-lg-12">
                    <img src="<?=ASSETS?>images/single-post.jpg" alt="single-post my-3" class="img-fluid">
                  </div>
                  <div class="post-description review-item mt-4">
                    ...
                    <img src="<?=ASSETS?>images/post-img.jpg" alt="post-image" class="img-fluid float-start me-3 col-md-5">
                        ...
                        <div class="comment-list padding-small">
                          <article class="comment-item d-flex flex-wrap mb-4">
                            <div class="col-lg-1 col-sm-3 me-4 mb-3">
                              <img src="<?=ASSETS?>images/commentor-item1.jpg" alt="default" class="img-fluid rounded-3">
                            </div>
                          ...
                          <article class="comment-item d-flex child-comments flex-wrap ps-5 mb-4">
                            <div class="col-lg-1 col-sm-3 me-4 mb-3">
                              <img src="<?=ASSETS?>images/commentor-item2.jpg" alt="default" class="img-fluid rounded-3">
                            </div>
                            <div class="col-lg-10 col-sm-9 author-wrap">
                              <div class="author-post">
                                <div class="comment-meta d-flex">
                          ...
                          <article class="comment-item d-flex flex-wrap">
                            <div class="col-lg-1 col-sm-3 me-4 mb-3">
                              <img src="<?=ASSETS?>images/commentor-item3.jpg" alt="default" class="img-fluid rounded-3">
                            </div>
                            <div class="col-lg-10 col-sm-9 author-wrap">
                              <div class="author-post">
                                <div class="comment-meta d-flex">
