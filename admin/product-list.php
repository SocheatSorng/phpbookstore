                                                  ...
                                                  <tbody>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <div class="d-flex align-items-center gap-2">
                                                                      <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                                           <img src="../assets/images/products/p-3.png" alt="" class="avatar-md">
                                                                      </div>
                                                                      <div>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <div class="d-flex align-items-center gap-2">
                                                                      <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                                           <img src="../assets/images/products/p-5.png" alt="" class="avatar-md">
                                                                      </div>
                                                                      <div>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <div class="d-flex align-items-center gap-2">
                                                                      <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                                           <img src="../assets/images/products/p-10.png" alt="" class="avatar-md">
                                                                      </div>
                                                                      <div>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <div class="d-flex align-items-center gap-2">
                                                                      <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                                           <img src="../assets/images/products/p-12.png" alt="" class="avatar-md">
                                                                      </div>
                                                                      <div>
