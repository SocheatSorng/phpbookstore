                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                              ...
                              <div class="collapse" id="sidebarProducts">
                                   <ul class="nav sub-navbar-nav">
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="<?=ROOT?>product-list">List</a>
                                        </li>
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="<?=ROOT?>product-grid">Grid</a>
                                        </li>
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="<?=ROOT?>product-details">Details</a>
                                        </li>
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="<?=ROOT?>product-edit">Edit</a>
                                        </li>
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="<?=ROOT?>product-add">Create</a>
                                        </li>
                                   </ul>
                              </div>
                         </li>
                         ...
                         <li class="nav-item">
                              ...
                              <div class="collapse" id="sidebarCategory">
                                   <ul class="nav sub-navbar-nav">
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="categoryAdd">List</a>
                                        </li>                         
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="<?=ROOT?>categoryEdit">Edit</a>
                                        </li>
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="<?=ROOT?>categoryAdd">Create</a>
                                        </li>
                                   </ul>
                              </div>
                         </li>
